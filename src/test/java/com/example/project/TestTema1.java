...
//               bos.toString().trim().replace("' ", "'").replace(" '","'"));
    ...
    //region 3 Întoarce identificator întrebare dup? nume
    @Test
    ...
    //region 4 Întoarce toate întreb?rile din system
    @Test
    ...
    public void testCreateQuizNameAlreadyExists()
    {
        ...
        // action
        Tema1.main(new String[]{"-create-question", "-u 'test'", "-p 'test'", "-text 'Temperatura se poate m?sura în'", "-type 'single'","-answer-1 'C'", "-answer-1-is-correct '1'", "-answer-2 'L'", "-answer-2-is-correct '0'"});
    ...
    //region 6 Întoarce identificator chestionar dup? nume
    ...
    //region 8 Întoarce detaliile unui chestionar în func?ie de identificatory java
    ...
    //region 9 Încarc? r?spunsuri chestionar
    @Test
    ...
    public void testSubmitQuiz2Of3QuestionsAnswered()
    {
        ...
        // action
        Tema1.main(new String[]{"-create-question", "-u 'test'", "-p 'test'", "-text 'Temperatura se poate m?sura în'", "-type 'multiple'","-answer-1 'Celsius'", "-answer-1-is-correct '1'", "-answer-2 'Litri'", "-answer-2-is-correct '0'", "-answer-3 'Fahrenheit'", "-answer-3-is-correct '1'"});
    ...
    //region 11 Întoarce solu?iile mele
    @Test
